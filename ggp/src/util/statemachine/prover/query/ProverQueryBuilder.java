package util.statemachine.prover.query;
...
public final class ProverQueryBuilder
{
	...
	public static List<GdlSentence> getContext(MachineState state)
	{
		return state.getContents();
	}

	public static List<GdlSentence> getContext(MachineState state, List<Role> roles, List<Move> moves)
	{
		List<GdlSentence> context = new ArrayList<GdlSentence>(state.getContents());
