...
/*
 * An implementation of a GDL flattener based on fixed-point analysis of the rules.
 * To use this class insert the following code in the PropNetFactory's :
...
public class EthansFlattener {
	...
	public EthansFlattener(List<Gdl> description)
	{
	...
	void updateDomains()
	{
		...
		{
			System.out.println("Beginning domain finding iteration: "+itrNum);
			...
			System.out.println("\tDone with iteration.  Considered "+rulesConsidered+" rules.");
		}
	}
