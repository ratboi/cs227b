...
public final class AimaProver extends Prover
{
	...
	private List<GdlSentence> ask(GdlSentence query, List<GdlSentence> context, boolean askOne)
	{
		...
		return new ArrayList<GdlSentence>(results);
	}
	...
	@Override
	public List<GdlSentence> askAll(GdlSentence query, List<GdlSentence> context)
	{
	...
	@Override
	public GdlSentence askOne(GdlSentence query, List<GdlSentence> context)
	{
		List<GdlSentence> results = ask(query, context, true);
	...
	@Override
	public boolean prove(GdlSentence query, List<GdlSentence> context)
	{
